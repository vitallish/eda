...
com <- unlist(out$state.region$common[1:5])


pander(out$state.region$common[1:5], style = "rmarkdown")



pander(out$state.region$common$full_table, style = "rmarkdown")

# pander(out$state.region$nchar_fn)

for (x in out$state.region$plot)
  print(x)
